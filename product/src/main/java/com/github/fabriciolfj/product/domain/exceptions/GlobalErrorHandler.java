...
import com.github.fabriciolfj.product.domain.exceptions.dto.Error;
...
public class GlobalErrorHandler implements ErrorWebExceptionHandler {
    ...
    protected HttpStatus resourceNotFoundException(Throwable throwable, Error errorDetails, HttpStatus httpStatus) {
